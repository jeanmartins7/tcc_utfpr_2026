...
\program{\textcolor{red}{Engenharia de computação}}
\programen{Undergradute Program in Computer Engineering}
\degree{\textcolor{red}{Bacharel}}
\degreearea{}
% Caso seja TSI:
...
\colorlet{RED}{red}
 ...
 \goal{\textcolor{red}{Trabalho de Conclusão de Curso de Graduação} apresentado}
 \course{Trabalho de Conclusão de Curso}


% Dados do TCC (precisa alterar)
\author{JEAN MARCEL PERES MARTINS}  % Seu nome
\authorbib{Martins, Jean Marcel} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Segmentação de Insetos Camuflados e de Pequena Escala utilizando Fusão de Fluxo Óptico em Redes Neurais Convolucionais} % Título do trabalho
...
\titleFA{Segmentação de Insetos Camuflados e de Pequena Escala utilizando Fusão de Fluxo Óptico em Redes Neurais Convolucionais}
...
\universitycampus{Campus Campo Cornélio Procópio}
...
\PalavraChaveA{Vis\~ao Computacional}%% Palavra-chave A
\PalavraChaveB{Rastreamento}%% Palavra-chave B
\PalavraChaveC{Redes Neurais Convolucionais}%% Palavra-chave C
\PalavraChaveD{Fluxo \'optico}%% Palavra-chave D
...
\KeywordA{Computer Vision}%% Keyword A
\KeywordB{Tracking}%% Keyword B
\KeywordC{Convolutional Neural Networks}%% Keyword C
\KeywordD{Optical Flow}%% Keyword D
